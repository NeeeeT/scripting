...
public OnPluginStart()
{
	...
	nmp_giveweapons_version = CreateConVar( "nmp_giveweapons_version", PLUGIN_VERSION, "NoMorePlugins Give Weapons", FCVAR_NOTIFY|FCVAR_REPLICATED|FCVAR_SPONLY|FCVAR_DONTRECORD );
	SetConVarString( nmp_giveweapons_version, PLUGIN_VERSION );
	HookConVarChange( nmp_giveweapons_version, OnConVarChanged_Version );
	
	HookConVarChange( nmp_gw_silent = CreateConVar( "nmp_gw_silent", bSilentAdmin ? "1" : "0", "Hide admin activity.", 1, true, 0.0, true, 1.0 ), OnConVarChanged );
